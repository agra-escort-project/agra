              ...
              <div style={{ position: 'sticky', top: '2rem' }}>
                <div style={{ background: 'var(--surface-color)', padding: '2rem', borderRadius: '24px', border: '1px solid var(--border-color)', boxShadow: 'var(--shadow-lg)' }}>
                  ...
                  <div style={{ marginTop: '2rem', paddingTop: '2rem', borderTop: '1px solid var(--border-color)', textAlign: 'center' }}>
                    ...
                    {/* WhatsApp */}
                    <a href={`https://wa.me/919876543210?text=Hello%20team,%20I%20am%20interested%20in%20booking%20${encodeURIComponent(formatName(model.name))}.%20Could%20you%20please%20share%20her%20current%20availability%20and%20rates?`} target="_blank" rel="noopener noreferrer" style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '1rem 0.5rem', background: '#fff', borderRadius: '16px', border: '1px solid rgba(37, 211, 102, 0.3)', boxShadow: '0 8px 20px rgba(37, 211, 102, 0.15)', color: '#128C7E', textDecoration: 'none', transition: 'transform 0.3s ease' }} className="premium-contact-card">
