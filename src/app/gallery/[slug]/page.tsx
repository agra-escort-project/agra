  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[var(--bg-color)]">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Title Header */}
              ...
              <h1 className="text-[24px] md:text-[32px] m-0 text-[var(--text-primary)] flex items-center font-extrabold tracking-tight">
                Meet {model.name}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline-block ml-3 -mt-1 w-8 h-8 md:w-10 md:h-10 text-[#10B981]">
        ...
        <section className="py-10 md:py-24 bg-[var(--surface-color)] border-t border-[var(--border-color)]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
