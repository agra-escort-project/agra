...
export const categories: Category[] = [
  { 
    id: "callgirls", 
    name: "Call Girls",
    description: "Explore the most beautiful and high-profile call girls offering premium companionship.",
    faqs: [
      { question: "What is the price of call girls in Agra?", answer: "Our premium call girls in Agra start from ₹2,500 for a standard session. VIP profiles may vary based on duration and services." },
      { question: "Are these independent call girls in Agra?", answer: "Yes, we connect you with highly verified independent call girls in Agra who offer a more personal and unhurried experience." },
      { question: "Do you offer hotel outcall services for call girls?", answer: "Absolutely. Our Agra call girls provide discrete outcall services to all major hotels and private residences across the city." },
      { question: "How can I verify the photos of the call girls?", answer: "We guarantee 100% genuine photos. The call girl you select from our gallery is exactly who will arrive at your location." },
      { question: "Is cash on delivery available for booking?", answer: "Yes, we operate on a strict cash-on-arrival model. You only pay when the call girl arrives at your location, ensuring zero advance payment scams." }
    ]
  },
  { 
    id: "bhabhi", 
  ...
  { 
    ...
    faqs: [
      ...
      { question: "Are housewife call girls safe and verified?", answer: "Absolutely. Every housewife model is personally interviewed and verified by our team to ensure your complete safety and satisfaction." },
  ...
  { 
    ...
    faqs: [
      ...
      { question: "What makes college girls different from regular call girls?", answer: "College girls offer a Girlfriend Experience (GFE). They are enthusiastic, fresh, highly energetic, and perfect for dates or parties." },
  ...
  { 
    ...
    faqs: [
      ...
      { question: "What is the price of Russian call girls in Agra?", answer: "Russian escorts fall under our premium luxury category. Rates are higher than local models due to their exclusivity and travel requirements." },
  ...
  { 
    ...
    faqs: [
      ...
      { question: "How much does a high-profile VIP call girl cost?", answer: "VIP call girls command premium rates starting from ₹10,000 and above, reflecting their beauty, status, and the exclusive service they provide." },
  ...
  { 
    ...
    faqs: [
      ...
      { question: "What is the price for athletic call girls in Agra?", answer: "Our gym girls fall into a specialized category, but their rates are highly competitive. Contact us for detailed pricing on specific models." },
